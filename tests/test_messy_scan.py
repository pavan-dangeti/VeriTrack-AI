"""Messy-scan OCR: a rotated, noisy, JPEG-compressed sheet must still yield usable repository data.

OCR may garble some cells; only high-signal fields (codes, emails) must survive for most rows.
"""
