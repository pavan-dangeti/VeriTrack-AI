"""HR read-only scoping: own manager's GETS sheets can be viewed and downloaded, nothing mutated,
no other manager's data."""
...
"""
GETS_CSV = """EMP CODE,Emp Name,Customer Leave,Company Leave
E-100,Ann Weaver,✓,
"""
