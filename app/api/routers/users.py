"""User management routes. MASTER_ADMIN creates MANAGER/EXECUTIVE; MANAGER creates HR under itself."""
...
async def user_profile(user_id: uuid.UUID, actor: AnyUser, db: DB):
    """Read-only profile drill-down; scoping is enforced in the service."""
    try:
